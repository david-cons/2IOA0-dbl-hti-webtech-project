...
def individualInfo(request):
    ...
    return JsonResponse({
        ...
        'all_time': {
            ...
            'most_emails_received' : p_most_received_emails,
            'number_received' : str(most_received_emails_nr),
            'most_emails_sent_to' : p_most_sent_emails,
        ...
        'time_filtered': {
            ...
            'most_emails_received' : p_most_received_emails_tf,
            'number_received' : str(most_received_emails_nr_tf),
            'most_emails_sent_to' : p_most_sent_emails_tf,
